...
public record CreditCard(String cardNumber, String holder) implements PaymentMethod {
    ...
    public String process(double amount) {
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        return String.format("Оплата картой *" + cardNumber.substring(cardNumber.length()-4) + ": " + amount + " руб."); // TODO: верните "Оплата картой *" + cardNumber.substring(cardNumber.length()-4) + ": " + amount + " руб."
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
    }
